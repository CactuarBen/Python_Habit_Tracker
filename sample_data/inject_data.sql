-- Insert sample habits (no current_streak column)
INSERT INTO habits (name, description, priority, periodicity, created_at)
VALUES
('Exercise', 'Morning workout', 2, 'daily', '2025-04-01T08:00:00'),
...
-- Completions for "Exercise" (daily, ID 1)
INSERT INTO completions (habit_id, completed_at)
VALUES
(1, '2025-04-01T09:00:00'),
...
-- Completions for "Weekly Review" (weekly, ID 2)
INSERT INTO completions (habit_id, completed_at)
VALUES
(2, '2025-04-06T10:00:00'),
(2, '2025-04-13T10:00:00'),
(2, '2025-04-20T10:00:00'),
(2, '2025-04-27T10:00:00');

-- Completions for "Read Book" (daily, ID 3)
INSERT INTO completions (habit_id, completed_at)
VALUES
(3, '2025-04-01T21:00:00'),
...
-- Completions for "Meditation" (daily, ID 4)
INSERT INTO completions (habit_id, completed_at)
VALUES
(4, '2025-04-01T07:30:00'),
(4, '2025-04-02T07:30:00'),
(4, '2025-04-04T07:30:00'),
(4, '2025-04-05T07:30:00');

-- Completions for "Monthly Budget" (monthly, ID 5)
INSERT INTO completions (habit_id, completed_at)
VALUES
(5, '2025-04-05T12:00:00'),
